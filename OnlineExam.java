...
{  
    ...
    {  
        ...
        if(current==5)  
        {  
            l.setText("Que6: What is the full form of JVM ?");  
            jb[0].setText("Java Virtual Machine");jb[1].setText("Java Virtual Method");jb[2].setText("Java Visual Method");jb[3].setText("None of the above");  
        }  
        if(current==6)  
        {  
        ...
        if(current==8)  
        {  
            l.setText("Que9: What is the full from AWT ?");  
            jb[0].setText("Abstract Window Toolkit");jb[1].setText("Absolute Window Toolkit");jb[2].setText("Abstract Window Tool");jb[3].setText("None");  
        }  
        if(current==9)  
        {  
